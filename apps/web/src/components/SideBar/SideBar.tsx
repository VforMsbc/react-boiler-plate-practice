    ...
    <>
      ...
      <Box id="sidebar">
        <Sidebar
          ...
          className={isCollapsed ? 'sidebarCollaps' : 'sidebarExpand'}
        >
          <Box className="header" id="sidebar-logo">
            <Box className="logoImg" sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              {/* <Typography sx={{ fontSize: '16px', fontWeight: 'bold', ml:1 }}>Dashboard</Typography> */}
            </Box>
          </Box>
